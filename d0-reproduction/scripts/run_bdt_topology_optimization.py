...
from zdc_selection import (
    MINUS_1N_THRESHOLD_GEV,
    PLUS_1N_THRESHOLD_GEV,
    decide as decide_zdc,
)
...
ZDC_PLUS_1N = PLUS_1N_THRESHOLD_GEV
ZDC_MINUS_1N = MINUS_1N_THRESHOLD_GEV
HF_PLUS_GAP = 9.2
HF_MINUS_GAP = 8.6
...
def collect_data_candidates(writer: FlatWriter, data_files: list[str], max_files: int) -> dict:
    ...
    for file_index, path in enumerate(files, 1):
        ...
        for entry in range(entries):
            ...
            zdc_decision = decide_zdc(zdc_plus, zdc_minus)
            gamma_n = zdc_decision.pass_0nxn
            n_gamma = zdc_decision.pass_xn0n
