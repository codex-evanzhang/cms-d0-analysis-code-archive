...
int scan_daughter_track_cuts(const char *mcPath,
  ...
  readme << "- Signal proxy: truth-matched prompt D0 MC after event-quality, fit-range, and D0 fiducial cuts. ZDC/HF topology is not required for MC because the checked official prompt MC does not provide usable ZDC neutron response.\n";
