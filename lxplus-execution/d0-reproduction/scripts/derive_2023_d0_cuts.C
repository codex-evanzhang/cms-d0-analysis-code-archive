...
constexpr double MASS_SB_LOW_MIN = 1.70;
constexpr double MASS_SB_LOW_MAX = 1.80;
constexpr double MASS_SB_HIGH_MIN = 1.93;
constexpr double MASS_SB_HIGH_MAX = 2.05;
...
bool InSideband(double mass) {
  return (mass > MASS_SB_LOW_MIN && mass < MASS_SB_LOW_MAX) ||
         (mass > MASS_SB_HIGH_MIN && mass < MASS_SB_HIGH_MAX);
}
...
int derive_2023_d0_cuts(const char *signalPath,
                        const char *dataPath,
