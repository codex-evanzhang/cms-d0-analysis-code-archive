...
config = config()
config.General.requestName = "d0_forest_crab_smoke_20260618_1648"
...
config.JobType.psetName = "/afs/cern.ch/work/e/evzhang/codex-work/analysis/d0-reproduction/crab-smoke/d0_forest_crab_smoke_20260618_1648/forest_crab_cfg.py"
config.JobType.outputFiles = ["HiForest_2023PbPbUPC_Jan24Reco_smoke.root"]
config.JobType.inputFiles = ["/afs/cern.ch/work/e/evzhang/codex-work/analysis/d0-reproduction/crab-smoke/d0_forest_crab_smoke_20260618_1648/inst_lumi.json"]
...
config.Data.outputDatasetTag = "d0_forest_crab_smoke_20260618_1648"
