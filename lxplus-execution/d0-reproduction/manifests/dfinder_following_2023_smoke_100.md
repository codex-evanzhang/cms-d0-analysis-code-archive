# 2023 Dfinder-Following D0 Run: smoke_100
...
- Max events: `100`
- Reference entries scanned per comparison stage: `200000`
...
- Dfinder output: `/eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/dfinder-following-2023/smoke_100/d0_dfinder_only.root`
- Local scratch output: `/afs/cern.ch/work/e/evzhang/codex-work/analysis/d0-reproduction/scratch/smoke_100_20260615T232838Z_d0_dfinder_only.root`
- Run directory: `/eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/dfinder-following-2023/smoke_100`
- Run log: `/afs/cern.ch/work/e/evzhang/codex-work/analysis/d0-reproduction/logs/run_2023_d0_dfinder_following_smoke_100_20260615T232838Z.log`

## Comparison Summary

## Counts

- `stage0_raw` Dfinder output: reproduced `2507`, reference `1030`
- `stage1_kin` 2<pT<12, |y|<2: reproduced `208`, reference `525`
- `stage2_track` track quality: reproduced `43`, reference `350`
- `stage3_topology` topology selected: reproduced `2`, reference `167`

## Peak Fits

- `reproduced_topology_selected` fit skipped: fewer than 30 entries.
- `reference_topology_selected` fit status: `0`, mean: `1.8442843 GeV`, sigma: `-0.0012753746 GeV`
