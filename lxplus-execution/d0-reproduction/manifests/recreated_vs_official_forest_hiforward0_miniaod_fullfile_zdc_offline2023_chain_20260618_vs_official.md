# Recreated vs Official Forest Validation: hiforward0_miniaod_fullfile_zdc_offline2023_chain_20260618_vs_official
...
- Recreated forest: `/eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/from-miniaod-chain/recreated-forest/hiforward0_miniaod_fullfile_zdc_offline2023_chain_20260618/HiForest_2023PbPbUPC_Jan24Reco_smoke.root`
...
- Output directory: `/eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/from-miniaod-chain/validation/hiforward0_miniaod_fullfile_zdc_offline2023_chain_20260618_vs_official`
- Log: `/afs/cern.ch/work/e/evzhang/codex-work/analysis/d0-reproduction/logs/recreated_vs_official_forest_hiforward0_miniaod_fullfile_zdc_offline2023_chain_20260618_vs_official_20260618T144034Z.log`
- Matcher CSV: `/eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/from-miniaod-chain/validation/hiforward0_miniaod_fullfile_zdc_offline2023_chain_20260618_vs_official/official_match_search.csv`
- Comparator manifest: `/eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/from-miniaod-chain/validation/hiforward0_miniaod_fullfile_zdc_offline2023_chain_20260618_vs_official/manifest.md`
