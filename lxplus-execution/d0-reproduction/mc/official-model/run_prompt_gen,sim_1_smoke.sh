...
scram b -j 2
mkdir -p /eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/official-mc-smoke/prompt_gen,sim_1
cd /eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/official-mc-smoke/prompt_gen,sim_1
cmsDriver.py EvanAnalysis/D0OfficialMC/PromptGNucleusToD0PhotonBeamA_5362GeV_pythia8_evtgen_cfi.py \
  --python_filename prompt_gen,sim_1_cfg.py \
  --fileout file:prompt_gen,sim_1.root \
  --mc \
  --eventcontent RAWSIM \
  --datatier GEN-SIM \
  ...
  --no_exec \
  -n 1
cmsRun prompt_gen,sim_1_cfg.py > prompt_gen,sim_1.log 2>&1
edmEventSize -v prompt_gen,sim_1.root > prompt_gen,sim_1_event_size.txt 2>&1 || true
printf 'output_dir=%s\n' /eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/official-mc-smoke/prompt_gen,sim_1
printf 'config=%s\n' /eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/official-mc-smoke/prompt_gen,sim_1/prompt_gen,sim_1_cfg.py
printf 'root=%s\n' /eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/official-mc-smoke/prompt_gen,sim_1/prompt_gen,sim_1.root
printf 'log=%s\n' /eos/user/e/evzhang/codex-eos/outputs/d0-reproduction/official-mc-smoke/prompt_gen,sim_1/prompt_gen,sim_1.log
